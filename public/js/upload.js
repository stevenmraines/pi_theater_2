...
Vue.component('year-end-input', __webpack_require__(479));
Vue.component('year-input', __webpack_require__(482));
Vue.component('year-released-input', __webpack_require__(485));
Vue.component('year-start-input', __webpack_require__(488));
      ...
      _vm.search
        ? _c(
            "a",
            {
              attrs: {
                href:
                  "https://www.impawards.com/search.php?search_data=" +
                  _vm.title,
                target: "_blank"
              }
            },
